...
@class VZBHomeDevice, VZBHomeFlowOptions, VZBKotlinEnumCompanion, VZBKotlinEnum<E>, VZBHomeFlowState, VZBKotlinArray<T>, VZBHomeFlowType, VZBHomeFlowsCommon, UIViewController, VZBHomeDeviceType, VZBHomeDeviceTypeCompanion;
